...
import com.saisai.domain.challenge.dto.projection.QPopularChallengeProjection;
...
public class ChallengeRepositoryImpl implements ChallengeRepositoryCustom {
    ...
    @Override
    public List<PopularChallengeProjection> findTop10CoursesByOngoingChallengeRides() {
        return queryFactory
            .select(new QPopularChallengeProjection(
                challenge.id,
                challenge.course.id,
                challenge.status,
                challenge.endedAt,
